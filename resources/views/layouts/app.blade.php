...
<head>
    ...
    <title>{{ config('app.name', 'SynthSocial') }}</title>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @else
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                @if(Auth::user()->hasRole('user admin')) <a class="dropdown-item"
                                                                            href="{{route('users')}}">Manage
                                    Users</a> @endif
                                @if(Auth::user()->hasRole('theme admin')) <a class="dropdown-item"
                                                                             href="{{route('themes')}}">Manage
                                    Themes</a> @endif
